...
import com.bocai.newnote.databinding.ActivityAboutBinding;
import com.bocai.newnote.mvp.model.bean.AboutDB;
import com.bocai.newnote.mvp.presenter.ActivityPresenter;
import com.bocai.newnote.mvp.ui.activity.WebViewActivity;
import com.bocai.newnote.mvp.ui.view.AboutAView;
...
public class AboutAImpl implements ActivityPresenter {
    ...
    public void codeClick(View view) {
        ...
        bundle.putString("URL", "http://git.oschina.net/lydnet/ZhuFengFM");
