...
import com.bocai.newnote.mvp.ui.activity.NoteDetailActivity;
...
public class IndexPreImpl implements ActivityPresenter, NavigationView.OnNavigationItemSelectedListener {
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab1 = mDataBinding.fab1;
        FloatingActionButton fab2 = mDataBinding.fab2;
        RxView.clicks(fab1).throttleFirst(500, TimeUnit.MILLISECONDS).subscribe((aVoid) ->mIndexView.readyGoForResult(EditActivity.class));
        RxView.clicks(fab2).throttleFirst(500, TimeUnit.MILLISECONDS).subscribe((aVoid) ->mIndexView.readyGo2ForResult(NoteDetailActivity.class));
