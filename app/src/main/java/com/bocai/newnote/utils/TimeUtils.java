...
public class TimeUtils {
     ...
     * @return
     */
    public static String getMyTime(long millistime) {
        SimpleDateFormat formatterDate = new SimpleDateFormat("MM月dd日 hh:mm");
        Date curDate = new Date(System.currentTimeMillis());
        String mAddtime = formatterDate.format(curDate);
        return mAddtime;
    }
}
